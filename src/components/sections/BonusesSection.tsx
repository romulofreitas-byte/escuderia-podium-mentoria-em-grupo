                    ...
                    <div className="text-center">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 justify-items-center">
                        {bonus.details.slice(0, 4).map((detail, idx) => (
                          <div key={idx} className="flex items-start sm:items-center space-x-2 text-center">
                            <div className="w-2 h-2 bg-yellow-400 rounded-full flex-shrink-0 mt-1.5 sm:mt-0" />
