...
// Usando encodeURI para garantir que caracteres especiais e espaços sejam tratados corretamente
const getTestimonialPath = (filename: string) => {
  return encodeURI(`/Testimonials Pódium/${filename}`);
};

const testimonials = [
  getTestimonialPath('IMG_0336.PNG'),
  getTestimonialPath('IMG_0337.PNG'),
  getTestimonialPath('IMG_0339.PNG'),
  getTestimonialPath('IMG_0417.PNG'),
  getTestimonialPath('IMG_0450.PNG'),
  getTestimonialPath('IMG_0464.PNG'),
  getTestimonialPath('IMG_0549.PNG'),
  getTestimonialPath('IMG_0576.PNG'),
  getTestimonialPath('IMG_0609.PNG'),
  getTestimonialPath('IMG_0932.PNG'),
  getTestimonialPath('IMG_1241.PNG'),
  getTestimonialPath('IMG_1742.PNG'),
  getTestimonialPath('IMG_1743.PNG'),
  getTestimonialPath('IMG_1867.PNG'),
  getTestimonialPath('IMG_2323.PNG'),
  getTestimonialPath('IMG_2526.PNG'),
  getTestimonialPath('IMG_2695.PNG'),
  getTestimonialPath('IMG_2865.PNG'),
  getTestimonialPath('IMG_2867.PNG'),
  getTestimonialPath('IMG_2868.PNG'),
  getTestimonialPath('IMG_2869.PNG'),
  getTestimonialPath('IMG_2870.PNG'),
  getTestimonialPath('IMG_2872.PNG'),
  getTestimonialPath('IMG_3486.PNG'),
  getTestimonialPath('IMG_6039.PNG'),
  getTestimonialPath('IMG_6301.PNG'),
  getTestimonialPath('IMG_7911.PNG'),
  getTestimonialPath('IMG_8052.PNG'),
  getTestimonialPath('IMG_8264.PNG'),
  getTestimonialPath('IMG_8264(1).PNG'),
  getTestimonialPath('IMG_8291.PNG'),
  getTestimonialPath('IMG_8735.PNG'),
  getTestimonialPath('IMG_9469.PNG'),
  getTestimonialPath('IMG_9470.PNG'),
  getTestimonialPath('IMG_9510.PNG'),
  getTestimonialPath('IMG_9582.PNG'),
  getTestimonialPath('IMG_9583.PNG'),
  getTestimonialPath('IMG_9584.PNG'),
  getTestimonialPath('IMG_9755.PNG'),
  getTestimonialPath('IMG_9874.PNG'),
];
