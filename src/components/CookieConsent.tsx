...
export const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 fade-in duration-500">
      <div className="w-full px-4 sm:px-0 max-w-sm sm:max-w-md">
            ...
            <div className="p-3 sm:p-5">
              <div className="flex items-start space-x-2 sm:space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="text-sm sm:text-base font-medium text-gray-200 mb-1.5 sm:mb-2">
                  ...
                  <div className="flex flex-col gap-1.5 sm:gap-2">
                    <button
                      ...
                      className="px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-600/50 text-gray-300 rounded-lg hover:border-gray-500/70 hover:text-gray-200 transition-all duration-200 text-xs sm:text-sm font-medium"
                    >
                      Apenas Essenciais
                    </button>
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 sm:px-4 sm:py-2 border border-amber-500/30 text-amber-400 rounded-lg hover:border-amber-500/50 hover:bg-amber-500/10 transition-all duration-200 text-xs sm:text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 sm:px-4 sm:py-2 bg-amber-500/90 text-gray-900 rounded-lg hover:bg-amber-500 transition-all duration-200 text-xs sm:text-sm font-medium"
                    >
                      Aceitar Todos
                    </button>
                  </div>
                ...
                <button
                  onClick={handleAcceptEssential}
                  className="flex-shrink-0 p-1 sm:p-1.5 text-gray-400 hover:text-gray-200 transition-colors"
                  aria-label="Fechar"
                >
            ...
            <div className="p-3 sm:p-5">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <button
                  ...
                  className="p-1 sm:p-1.5 text-gray-400 hover:text-gray-200 transition-colors"
                  aria-label="Voltar"
                >
                  <X className="w-3 h-3 sm:w-4 sm:h-4" />
                </button>
              ...
              <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                {/* Essential Cookies */}
                <div className="flex items-center justify-between p-2.5 sm:p-3 bg-gray-800/30 border border-gray-700/50 rounded-lg">
                  <div className="flex-1">
